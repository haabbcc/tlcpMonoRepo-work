...
/* Serialized OID's */
static const unsigned char so[6773] = {
    ...
    0x2A,0x81,0x1C,0xCF,0x55,0x01,0x83,0x79,0x01,  /* [ 6646] OBJ_ML_DSA_44_with_SM3 */
    0x2A,0x81,0x1C,0xCF,0x55,0x01,0x83,0x79,0x02,  /* [ 6655] OBJ_ML_DSA_65_with_SM3 */
    0x2A,0x81,0x1C,0xCF,0x55,0x01,0x83,0x79,0x03,  /* [ 6664] OBJ_ML_DSA_87_with_SM3 */
    0x2A,0x81,0x1C,0xCF,0x55,0x01,0x83,0x7A,0x01,  /* [ 6673] OBJ_ML_DSA_44_SM2_with_SM3 */
    0x2A,0x81,0x1C,0xCF,0x55,0x01,0x83,0x7A,0x02,  /* [ 6682] OBJ_ML_DSA_65_SM2_with_SM3 */
    0x2A,0x81,0x1C,0xCF,0x55,0x01,0x83,0x7A,0x03,  /* [ 6691] OBJ_ML_DSA_87_SM2_with_SM3 */
    0x2A,0x81,0x1C,0xCF,0x55,0x01,0x83,0x7B,0x01,  /* [ 6700] OBJ_ML_KEM_512_SM2 */
    0x2A,0x81,0x1C,0xCF,0x55,0x01,0x83,0x7B,0x02,  /* [ 6709] OBJ_ML_KEM_768_SM2 */
    0x2A,0x81,0x1C,0xCF,0x55,0x01,0x83,0x7B,0x03,  /* [ 6718] OBJ_ML_KEM_1024_SM2 */
    0x2A,0x81,0x1C,0xCF,0x55,0x01,0x83,0x7C,0x01,  /* [ 6727] OBJ_ML_DSA_44_SM2 */
    0x2A,0x81,0x1C,0xCF,0x55,0x01,0x83,0x7C,0x02,  /* [ 6736] OBJ_ML_DSA_65_SM2 */
    0x2A,0x81,0x1C,0xCF,0x55,0x01,0x83,0x7C,0x03,  /* [ 6745] OBJ_ML_DSA_87_SM2 */
    0x2A,0x81,0x1C,0xCF,0x55,0x01,0x82,0x30,0x01,  /* [ 6754] OBJ_ML_DSA_44_SPKI */
    0x2A,0x81,0x1C,0xCF,0x55,0x01,0x82,0x2F,0x01,  /* [ 6763] OBJ_ML_KEM_512_SPKI */
};
...
static const ASN1_OBJECT nid_objs[NUM_NID] = {
    ...
    {"ML-DSA-44-SM3", "ML-DSA-44-with-SM3", NID_ML_DSA_44_with_SM3, 9, &so[6646]},
    {"ML-DSA-65-SM3", "ML-DSA-65-with-SM3", NID_ML_DSA_65_with_SM3, 9, &so[6655]},
    {"ML-DSA-87-SM3", "ML-DSA-87-with-SM3", NID_ML_DSA_87_with_SM3, 9, &so[6664]},
    {"ML-DSA-44-SM2-SM3", "ML-DSA-44-SM2-with-SM3", NID_ML_DSA_44_SM2_with_SM3, 9, &so[6673]},
    {"ML-DSA-65-SM2-SM3", "ML-DSA-65-SM2-with-SM3", NID_ML_DSA_65_SM2_with_SM3, 9, &so[6682]},
    {"ML-DSA-87-SM2-SM3", "ML-DSA-87-SM2-with-SM3", NID_ML_DSA_87_SM2_with_SM3, 9, &so[6691]},
    {"ML-KEM-512-SM2", "ML-KEM-512-SM2", NID_ML_KEM_512_SM2, 9, &so[6700]},
    {"ML-KEM-768-SM2", "ML-KEM-768-SM2", NID_ML_KEM_768_SM2, 9, &so[6709]},
    {"ML-KEM-1024-SM2", "ML-KEM-1024-SM2", NID_ML_KEM_1024_SM2, 9, &so[6718]},
    {"ML-DSA-44-SM2", "ML-DSA-44-SM2", NID_ML_DSA_44_SM2, 9, &so[6727]},
    {"ML-DSA-65-SM2", "ML-DSA-65-SM2", NID_ML_DSA_65_SM2, 9, &so[6736]},
    {"ML-DSA-87-SM2", "ML-DSA-87-SM2", NID_ML_DSA_87_SM2, 9, &so[6745]},
    {"id-ML-DSA-44-SPKI", "ML-DSA-44-SPKI", NID_ML_DSA_44_SPKI, 9, &so[6754]},
    {"id-ML-KEM-512-SPKI", "ML-KEM-512-SPKI", NID_ML_KEM_512_SPKI, 9, &so[6763]},
    {"KxECCKyber", "kx-ecckyber", NID_kx_ecckyber},
    {"KxECDHEKyber", "kx-ecdhekyber", NID_kx_ecdhekyber},
...
static const unsigned int sn_objs[NUM_SN] = {
    ...
    1044,    /* "KxSRP" */
     ...
     911,    /* "MGF1" */
    1329,    /* "ML-DSA-44-SM2" */
    1323,    /* "ML-DSA-44-SM2-SM3" */
    1320,    /* "ML-DSA-44-SM3" */
    1330,    /* "ML-DSA-65-SM2" */
    1324,    /* "ML-DSA-65-SM2-SM3" */
    1321,    /* "ML-DSA-65-SM3" */
    1331,    /* "ML-DSA-87-SM2" */
    1325,    /* "ML-DSA-87-SM2-SM3" */
    1322,    /* "ML-DSA-87-SM3" */
    1328,    /* "ML-KEM-1024-SM2" */
    1326,    /* "ML-KEM-512-SM2" */
    1327,    /* "ML-KEM-768-SM2" */
     388,    /* "Mail" */
     393,    /* "NULL" */
    ...
    1257,    /* "hmacWithSM3" */
     ...
     442,    /* "iA5StringSyntax" */
     783,    /* "id-DHBasedMac" */
    1332,    /* "id-ML-DSA-44-SPKI" */
    1333,    /* "id-ML-KEM-512-SPKI" */
...
static const unsigned int ln_objs[NUM_LN] = {
    ...
    1150,    /* "ISO-UA" */
     ...
     504,    /* "MIME MHS" */
    1329,    /* "ML-DSA-44-SM2" */
    1323,    /* "ML-DSA-44-SM2-with-SM3" */
    1332,    /* "ML-DSA-44-SPKI" */
    1320,    /* "ML-DSA-44-with-SM3" */
    1282,    /* "ML-DSA-65" */
    1330,    /* "ML-DSA-65-SM2" */
    1324,    /* "ML-DSA-65-SM2-with-SM3" */
    1321,    /* "ML-DSA-65-with-SM3" */
    1331,    /* "ML-DSA-87-SM2" */
    1325,    /* "ML-DSA-87-SM2-with-SM3" */
    1322,    /* "ML-DSA-87-with-SM3" */
    1328,    /* "ML-KEM-1024-SM2" */
    1326,    /* "ML-KEM-512-SM2" */
    1333,    /* "ML-KEM-512-SPKI" */
    1327,    /* "ML-KEM-768-SM2" */
     388,    /* "Mail" */
     383,    /* "Management" */
...
static const unsigned int obj_objs[NUM_OBJ] = {
    ...
    1333,    /* OBJ_ML_KEM_512_SPKI              1 2 156 10197 1 303 1 */
    1332,    /* OBJ_ML_DSA_44_SPKI               1 2 156 10197 1 304 1 */
    1257,    /* OBJ_hmacWithSM3                  1 2 156 10197 1 401 2 */
    1320,    /* OBJ_ML_DSA_44_with_SM3           1 2 156 10197 1 505 1 */
    1321,    /* OBJ_ML_DSA_65_with_SM3           1 2 156 10197 1 505 2 */
    1322,    /* OBJ_ML_DSA_87_with_SM3           1 2 156 10197 1 505 3 */
    1323,    /* OBJ_ML_DSA_44_SM2_with_SM3       1 2 156 10197 1 506 1 */
    1324,    /* OBJ_ML_DSA_65_SM2_with_SM3       1 2 156 10197 1 506 2 */
    1325,    /* OBJ_ML_DSA_87_SM2_with_SM3       1 2 156 10197 1 506 3 */
    1326,    /* OBJ_ML_KEM_512_SM2               1 2 156 10197 1 507 1 */
    1327,    /* OBJ_ML_KEM_768_SM2               1 2 156 10197 1 507 2 */
    1328,    /* OBJ_ML_KEM_1024_SM2              1 2 156 10197 1 507 3 */
    1329,    /* OBJ_ML_DSA_44_SM2                1 2 156 10197 1 508 1 */
    1330,    /* OBJ_ML_DSA_65_SM2                1 2 156 10197 1 508 2 */
    1331,    /* OBJ_ML_DSA_87_SM2                1 2 156 10197 1 508 3 */
