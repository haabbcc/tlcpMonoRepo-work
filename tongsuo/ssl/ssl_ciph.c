...
static const ssl_cipher_table ssl_cipher_table_kx[] = {
    ...
    {SSL_kECCKyber, NID_kx_ecckyber},
    {SSL_kECDHEKyber, NID_kx_ecdhekyber},
    {SSL_kKyber,    NID_kx_kyber},
    {SSL_kKyberAigisEnc, NID_kx_kyber},
    {SSL_kANY,      NID_kx_any}
};
...
char *SSL_CIPHER_description(const SSL_CIPHER *cipher, char *buf, int len)
{
    ...
    case SSL_kECCKyber:
        kx = "ECCKyber";
        break;
    case SSL_kECDHEKyber:
        kx = "ECDHEKyber";
        break;
    case SSL_kKyber:
        kx = "Kyber-Dilithium-KEM";
        break;
    case SSL_kKyberAigisEnc:
        kx = "Kyber-AigisEnc-Dilithium-KEM";
        break;
    case SSL_kANY:
        kx = "any";
        break;
