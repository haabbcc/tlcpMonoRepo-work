...
/*
 * Tongsuo: TLS 1.3 GM dual-certificate (sign + encryption) with deferred
 * master secret (ClientHello / EncryptedExtensions). Private use range.
 */
# define TLSEXT_TYPE_tls1_3_gm_dual_cert         0xff04
/* Kyber768 ciphertext for TLS 1.3 SM2 hybrid KEX (must be in ServerHello, not EE) */
# define TLSEXT_TYPE_tls1_3_kyber768_ciphertext 0xff05
